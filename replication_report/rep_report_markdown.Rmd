...
id <- data.frame(workerid = jd$WorkerId, 
                ...
                environmentalist =
                  ifelse(is.null(unlist(jd$answers$data$environmentalist)),NA,
                                          unlist(jd$answers$data$environmentalist)),
...
```{r, message=FALSE, warning=FALSE}
ggplot(d, aes(x=leg_mot_index, y=beh_int_index, color=condition)) + 
  geom_point() +
...
```{r, message=FALSE, warning=FALSE}
ggplot(d, aes(x=leg_mot_index, y=env_att_index, color=condition)) + 
  geom_point() +
  geom_smooth(method = lm)
```
