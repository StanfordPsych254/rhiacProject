...
Using a sample of 312 participants, the smallest effect size that the study will detect with 80% power:
...
**Writing activity**
Participants will be assigned to one of two conditions. The two conditions will be posted as two sepatate MTurk HITs, given the different amounts of time required. As per the original experiment, "In the legacy condition, participants began by writing a short essay describing what they want to be remembered for by future generations...The essay-writing task was omitted in the control condition, which otherwise followed the same procedure as the legacy condition." The writing task will be copied verbatim from the project's supplemental materials online.
