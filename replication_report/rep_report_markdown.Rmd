...
In the original study, all participants were paid the same amount. However, in this study, we will pay a base rate of $0.20, and an additional bonus of $0.50 to the people in the legacy motives priming condition (ie. the people who write the 5 minute essay). 

In addition, in the original study the average time taken to write the essay was 6.5 minutes. However, we will be shortening the essay writing task to 5 minutes instead. 
